...
class CUDAState(clawpack.petclaw.State):
    r"""  See the corresponding PetClaw State documentation."""
...
class CUDASolver2D(clawpack.petclaw.ClawSolver2D):
    r"""  See the corresponding PetClaw Solver documentation."""
